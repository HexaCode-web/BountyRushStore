...
import CreateToast from "@/lib/createToast.js";
import productDistributor from "@/lib/productDistributor.js";
import SETDOC from "@/lib/setDoc.js";
import GETDOC from "@/lib/getDoc.js";
    ...
    const CheckUser = async () => {
      ...
      if (typeof window !== "undefined") {
        ...
        if (storedActiveUser) {
          ...
          fetchedUser?.Roles.includes(649) ? setError(false) : setError(true);
        }
      }
    };
    CheckUser();
